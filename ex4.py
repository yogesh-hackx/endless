...
class Block(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/enemy.png').convert()
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/1.png').convert()
...
class Enemy2(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/6.png').convert()
        self.image.set_colorkey(black)
...
class Enemy3(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/3.png').convert()
        self.image.set_colorkey(black)
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/5.png').convert()
        self.image.set_colorkey(black)
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/bullet5.png').convert()
        self.image.set_colorkey(white)
...
class EBullet(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('/home/vishal/Documents/varsha/small/bullet3.png').convert()
        self.image.set_colorkey(white)
        # self.image = pygame.Surface([6, 25])
        # self.image.fill(white)
...
object_width = 50
background = pygame.image.load('/home/vishal/Documents/varsha/small/b2.jpg')
title = pygame.image.load('/home/vishal/Documents/varsha/small/m2.PNG')
game_display = pygame.display.set_mode([game_display_width, game_display_height])
font = pygame.font.Font('/home/vishal/Documents/varsha/Algerian Regular.ttf', 25)
...
def text_sizer(surf, text, size, x, y):
    font = pygame.font.Font('/home/vishal/Documents/varsha/Algerian Regular.ttf', 30)
